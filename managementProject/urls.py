...
from teachersApp.views import teacher_class_detail, pupil_report_create_or_edit  # <-- added
...
urlpatterns = [
    ...
    path('dashboard/teacher/report/<int:pupil_id>/', pupil_report_create_or_edit, name='pupil_report'),  # <-- added
