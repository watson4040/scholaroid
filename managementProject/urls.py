...
urlpatterns = [
    ...
    path(
        "api/conversation/<int:user_id>/",
        get_conversation_api,
        name="get_conversation_api",
    ),

    path(
        "api/send-message/<int:user_id>/",
        send_message_api,
    ...
    path(
        "exams/",
        include("examsApp.urls"),
    ),

    path(
        "fees/",
        include("feesApp.urls"),
    ),
]
...
#     uploaded documents
#
# are stored under MEDIA_ROOT.
#
# During local development Django must explicitly serve
# these files.
#
# This does NOT affect production deployment.
#
# ==========================================================
